...
$password=ConvertTo-SecureString "dtopassb6" -AsPlainText -Force
$cred=New-Object System.Management.Automation.PSCredential("dtouserb6",$password)
...
function setStateUsing {
    ...
    Invoke-SqlUpdate "UPDATE general_keys SET keystate=1,bancada='b6' WHERE idkey=$idkey;"
