...
$password=ConvertTo-SecureString "dtopassb2" -AsPlainText -Force
$cred=New-Object System.Management.Automation.PSCredential("dtouserb2",$password)
...
function setStateUsing {
    ...
    Invoke-SqlUpdate "UPDATE general_keys SET keystate=1,bancada='b2' WHERE idkey=$idkey;"
