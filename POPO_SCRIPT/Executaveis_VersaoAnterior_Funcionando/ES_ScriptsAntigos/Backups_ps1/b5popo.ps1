...
$password=ConvertTo-SecureString "dtopassb5" -AsPlainText -Force
$cred=New-Object System.Management.Automation.PSCredential("dtouserb5",$password)
...
function setStateUsing {
    ...
    Invoke-SqlUpdate "UPDATE general_keys SET keystate=1,bancada='b5' WHERE idkey=$idkey;"
